        ...
        <Reveal className="differentials-head">
          <div>
            <div className="eyebrow eyebrow-gold">
              ...
              Por que o Almeida &amp; Costa
            </div>
            <h2 className="section-title">Quatro compromissos que orientam cada caso</h2>
          </div>
          <p>Não prometemos resultado. Prometemos método, clareza e presença.</p>
        </Reveal>
